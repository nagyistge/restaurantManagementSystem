            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
				   ...
				   <div class="col-lg-4444">
                        <h2 type="button" data-toggle="modal" data-target="#myModal" >Employees Table</h2>
                    ...
                    <div class="col-lg-4444">
                        <h2>OpenBillingOutlet</h2>
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <?php 
                                	GetTable('OpenBillingOutlet');
                                ?>
                            </table>
                        </div>
                    </div>
                ...
                <div class="col-lg-4444">
                        <h2>CloseBillingOutlet</h2>
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <?php 
                                	GetTable('CloseBillingOutlet');
                                ?>
                            </table>
                        </div>
                </div>
                ...
                <div class="col-lg-4444">
                <h2>Physical Stock Entry</h2>
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <?php 
                                	GetTable('PhysicalStockEntry');
                                ?>
                            </table>
                </div>
                </div>
